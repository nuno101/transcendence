...
def send_user_notification(user_id, data):
  message_group(f"user_{user_id}", "send_notification", data)

def send_channel_notification(channel_id, data):
  message_group(f"channel_{channel_id}", "send_notification", data)
