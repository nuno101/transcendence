...
GAME_403 = "No permission to access game"

# Channels errors
CHANNEL_404 = "Channel not found"
CHANNEL_403 = "No permission to access channel"

# Message errors
MESSAGE_404 = "Message not found"
MESSAGE_403 = "No permission to access message"
