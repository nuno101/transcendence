...
# Endpoint: /games - used to save the score of games w/o tournament
...
class GameView(View):
	...
	def post(self, request):
		...
		game = Game(tournament=None, player1=player1, player2=player2)
...
class GameDetail(View):
	...
	def get(self, request, game_id):
		return JsonResponse(Game.objects.get(id=game_id).serialize())
